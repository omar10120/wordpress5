...
function tc_e_commerce_shop_customize_register( $wp_customize ) {
    ...
    //About Section
		...
		$wp_customize->add_control('tc_e_commerce_shop_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Demo</h3>Our premium version of TC E-Commerce Shop has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.<br> <a target='_blank' href='". esc_url('https://www.themescaliber.com/tc-e-commerce-shop/') ." '>View Demo</a>",
		...
		$wp_customize->add_control('tc_e_commerce_shop_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Support</h3>Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.<br><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/tc-e-commerce-shop/') ." '>Support Forum</a>",
			'section'=> 'tc_e_commerce_shop_about_theme'
		));
