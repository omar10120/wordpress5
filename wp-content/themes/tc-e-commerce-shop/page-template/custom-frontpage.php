...
<main id="main" role="main">
  ...
  <?php if( get_theme_mod('tc_e_commerce_shop_slider_hide') != '' || get_theme_mod( 'tc_e_commerce_shop_mobile_media_slider', true) != ''){ ?>
    <section id="slider">
                ...
                <div class="inner_carousel">
                  ...
                  <?php if ( get_theme_mod('tc_e_commerce_shop_slider_button_text','LEARN MORE') != '' && get_theme_mod('tc_e_commerce_shop_slider_button',true) != ''|| get_theme_mod('tc_e_commerce_shop_slider_button_responsive',true) != ''|| get_theme_mod('tc_e_commerce_shop_slider_button_link') != '') {?>
                    <div class="more-btn hvr-sweep-to-right">              
                      <a href="<?php echo esc_url(get_theme_mod('tc_e_commerce_shop_slider_button_link','')); ?>"><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_slider_button_text',__('LEARN MORE', 'tc-e-commerce-shop')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_slider_button_text',__('LEARN MORE', 'tc-e-commerce-shop')) ); ?></span></a>
                    </div>
                  <?php }?>
                </div>
              </div>
